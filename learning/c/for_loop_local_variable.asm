...
for_loop_local_variable:     file format elf64-x86-64
...
0000000000001060 <_start>:
    ...
    1078:	48 8d 3d 01 01 00 00 	lea    0x101(%rip),%rdi        # 1180 <main>
...
0000000000001149 <test_for_loop>:
    ...
    1163:	eb 0d                	jmp    1172 <test_for_loop+0x29>
    1165:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1168:	48 98                	cltq
    116a:	48 01 45 f8          	add    %rax,-0x8(%rbp)
    116e:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    1172:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1175:	3b 45 ec             	cmp    -0x14(%rbp),%eax
    1178:	7c eb                	jl     1165 <test_for_loop+0x1c>
...
0000000000001180 <main>:
    ...
    118c:	c7 45 f4 64 00 00 00 	movl   $0x64,-0xc(%rbp)
    1193:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1196:	89 c7                	mov    %eax,%edi
    1198:	e8 ac ff ff ff       	call   1149 <test_for_loop>
    119d:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11a1:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11a5:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11a8:	89 c6                	mov    %eax,%esi
