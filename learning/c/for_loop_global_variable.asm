...
for_loop_global_variable:     file format elf64-x86-64
...
0000000000001149 <test_for_loop>:
    1149:	f3 0f 1e fa          	endbr64
    114d:	55                   	push   %rbp
    114e:	48 89 e5             	mov    %rsp,%rbp
    1151:	89 7d ec             	mov    %edi,-0x14(%rbp)
    1154:	48 c7 45 f8 00 00 00 	movq   $0x0,-0x8(%rbp)
    115b:	00 
    115c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%rbp)
    1163:	eb 1b                	jmp    1180 <test_for_loop+0x37>
    1165:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1168:	48 63 d0             	movslq %eax,%rdx
    116b:	48 8b 05 a6 2e 00 00 	mov    0x2ea6(%rip),%rax        # 4018 <g_sum>
    1172:	48 01 d0             	add    %rdx,%rax
    1175:	48 89 05 9c 2e 00 00 	mov    %rax,0x2e9c(%rip)        # 4018 <g_sum>
    117c:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    1180:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1183:	3b 45 ec             	cmp    -0x14(%rbp),%eax
    1186:	7c dd                	jl     1165 <test_for_loop+0x1c>
    1188:	90                   	nop
    1189:	90                   	nop
    118a:	5d                   	pop    %rbp
    118b:	c3                   	ret
...
000000000000118c <main>:
    ...
    1198:	c7 45 fc 64 00 00 00 	movl   $0x64,-0x4(%rbp)
    119f:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11a2:	89 c7                	mov    %eax,%edi
    11a4:	e8 a0 ff ff ff       	call   1149 <test_for_loop>
    11a9:	48 8b 15 68 2e 00 00 	mov    0x2e68(%rip),%rdx        # 4018 <g_sum>
